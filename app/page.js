      ...
      <section className="py-16 bg-blue-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Clinic Policy */}
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Clinic Policy</h2>
              <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
                <div className="space-y-6">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 mb-1">Appointment Policy</h3>
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 mb-1">Document Fees</h3>
                      <p className="text-gray-600 text-sm">
                  ...
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h3 className="font-semibold text-gray-800 mb-1">New Patients</h3>
                      <p className="text-gray-600 text-sm">
            ...
            {/* Hours of Operation */}
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-6">Hours of Operation</h2>
              <div className="bg-white rounded-xl shadow-lg p-6 md:p-8">
                <div className="space-y-4 mb-6">
                  {[
                    ...
                    <div key={index} className="flex justify-between items-center py-2 border-b border-gray-100 last:border-b-0">
                      <span className={`font-medium ${schedule.day === 'Sunday' ? 'text-red-600' : 'text-gray-700'}`}>
                        {schedule.day}
                      </span>
                      <span className={schedule.hours === 'Closed' ? 'text-red-600 font-medium' : 'text-gray-600'}>
                        {schedule.hours}
                      </span>
                    </div>
                  ))}
