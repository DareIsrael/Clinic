          ...
          <div className="space-y-16">
              ...
              <div key={index} id={section.id} className="scroll-mt-24">
                <div className="bg-white rounded-2xl p-8 border border-sky-200 shadow-lg">
                  <div className="flex items-start gap-4 mb-6">
                    <div className="flex-shrink-0 p-3 bg-sky-100 rounded-lg text-sky-600">
                      {section.icon}
                    </div>
                    <div>
                      ...
                      {section.subtitle && (
                        <p className="text-lg text-sky-700 font-medium">{section.subtitle}</p>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    {section.items.map((item, itemIndex) => (
                      <div key={itemIndex} className="border-l-4 border-sky-200 pl-6">
                        {item.title && (
                          ...
                          <ul className="space-y-2 mt-3 mx-auto text-sm sm:text-base  leading-relaxed">
                            {item.list.map((listItem, listIndex) => (
                              <li key={listIndex} className="flex items-start">
                                ...
                                <span className="text-sky-700">{listItem}</span>
                              </li>
                            ))}
                          </ul>
                        )}
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              {additionalSections.map((section, index) => (
                <div key={index} className="bg-white rounded-2xl p-8 border border-sky-200 shadow-lg">
                  <div className="flex items-start gap-4 mb-6">
                    <div className="flex-shrink-0 p-3 bg-sky-100 rounded-lg text-sky-600">
                      {section.icon}
                    </div>
      ...
      <section className="py-16 bg-sky-900">
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="/contact"
              className="px-8 py-3 bg-white text-sky-600 rounded-lg hover:bg-sky-50 transition-colors duration-200 font-medium shadow-lg hover:shadow-xl"
            >
              Contact Us
            </a>
