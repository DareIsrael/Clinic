...
export default function PoliciesPage() {
  ...
  const policySections = [
    {
      ...
      items: [
        {
          title: t('policy_r1_title'),
          content: t('policy_r1_text')
        },
        {
          title: t('policy_r2_title'),
          content: t('policy_r2_text')
        },
        {
          title: t('policy_r3_title'),
          content: t('policy_r3_text')
        },
        {
          title: t('policy_r4_title'),
          content: t('policy_r4_text')
        },
        {
          title: t('policy_r5_title'),
          content: t('policy_r5_text')
        },
        {
          title: t('policy_r6_title'),
          content: t('policy_r6_text')
        }
      ]
    },
    {
      ...
      items: [
        {
          title: t('policy_res1_title'),
          content: t('policy_res1_text')
        },
        {
          title: t('policy_res2_title'),
          content: t('policy_res2_text')
        },
        {
          title: t('policy_res3_title'),
          content: t('policy_res3_text')
        }
      ]
    },
    {
      id: 'appointment-policy',
      title: t('policy_appt_late_title'),
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      items: [
        {
          title: t('policy_app1_title'),
          content: t('policy_app1_text')
        },
        {
          title: t('policy_app2_title'),
          content: t('policy_app2_text')
        },
        {
          title: t('policy_app3_title'),
          content: t('policy_app3_text')
        },
        {
          title: t('policy_app4_title'),
          content: t('policy_app4_text')
        }
      ]
    },
    {
      id: 'prescription-policy',
      title: t('policy_rx_title'),
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
        </svg>
      ...
      items: [
        {
          content: t('policy_rx1_text')
        },
        {
          content: t('policy_rx2_text')
        },
        {
          content: t('policy_rx3_text')
        },
        {
          content: t('policy_rx4_text')
        }
      ]
    },
    {
      id: 'non-ohip-services',
      title: t('policy_non_ohip_title'),
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      items: [
        ...
        {
          content: t('policy_non2_text')
        }
      ]
    },
    {
      id: 'clinic-conduct',
      title: t('policy_conduct_title'),
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      items: [
        {
          title: t('policy_con1_title'),
          content: t('policy_con1_text')
        },
        {
          title: t('policy_con2_title'),
          content: t('policy_con2_text')
        },
        {
          title: t('policy_con3_title'),
          content: t('policy_con3_text')
        }
      ]
    },
    {
  ...
  const additionalSections = [
    {
      title: t('policy_prep_visit_title'),
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: t('policy_after_hours_title'),
      icon: (
        <svg className="w-6 h-6 sm:w-8 sm:h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      items: [
        {
          content: t('policy_after_t1')
        },
        {
          content: t('policy_after_t2')
        },
        {
          content: t('policy_after_t3')
        }
      ]
    }
  ];
