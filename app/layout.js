...
//                     <span><span className="font-medium">Fax:</span> (343) 362-3021</span>
//                   </p>
//                     <li className="flex items-center gap-2">
              ...
              <div className="max-w-7xl mx-auto px-4 py-12">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                  ...
                  <div>
                    ...
                    <p className="text-gray-300 text-sm leading-relaxed mb-4">
                      ...
                      the Ottawa community with personalized care from
                  ...
                  <div>
                    ...
                    <ul className="space-y-2">
                      <li>
                        <Link
                          href="/"
                          className="text-gray-300 hover:text-sky-400 transition-colors text-sm flex items-center gap-2"
                        >
                  ...
                  <div>
                    ...
                    <ul className="space-y-3">
                      ...
                      <li className="flex items-start gap-3 text-gray-300 text-sm">
                        <span className="w-4 h-4 text-sky-400 mt-0.5 flex-shrink-0">
                          📠
                        </span>
                        <div>
                      ...
                      <li className="flex items-start gap-3 text-gray-300 text-sm">
                        ...
                        <div>
                          ...
                          <a
                            href="mailto:contact@stmaryrideauclinic.com"
                ...
                <div className="border-t border-gray-700 pt-8 mb-8">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                      <h3 className="text-md font-semibold mb-3 text-sky-400">
                        Emergency Care
                      </h3>
                      <div className="bg-red-900/20 border border-red-700/50 rounded-lg p-3">
                        <p className="text-gray-300 text-sm">
                          For medical emergencies, please call{" "}
                          <span className="font-bold text-red-400">911</span> or
                ...
                <div className="border-t border-gray-700 pt-6 text-center">
                  <p className="text-gray-400 text-sm">
                    &copy; {new Date().getFullYear()} St Mary Rideau Family
